...
export default function KitBot({ repoName, username, currentFile, fileContent, repoContext, userId }: KitBotProps) {
    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            role: "assistant",
            content: "Hi! I'm KitBot 🐱‍🏗️! Powered by Google Gemini 2.5 Flash Preview, I can help you understand your code, explain functions, find bugs, or answer questions about this repository. What would you like to build today?",
        },
    ]);
