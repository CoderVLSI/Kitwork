...
export default function RepoPage({ params }: { params: Promise<{ user: string; repo: string }> }) {
    ...
    const submitFile = async () => {
        ...
        try {
            ...
            closeFileModal();
            // Refresh the tree by setting a dummy state update
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        {isOwner && (
                            <button
                                ...
                                className="px-3 py-1.5 rounded-lg bg-purple-600 hover:bg-purple-500 text-white text-sm font-medium transition-all flex items-center gap-1.5"
                            >
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                {tree === undefined ? (
                                    ...
                                    <div className="p-12 text-center">
                                        ...
                                        {isOwner && !currentPath && (
                                            <button
                                                onClick={openFileModal}
                                                className="mt-4 px-4 py-2 rounded-lg bg-purple-600 hover:bg-purple-500 text-white text-sm font-medium transition-all"
                                            >
                                                + Add your first file
                                            </button>
                                        )}
                    ...
                    <div className="glass rounded-2xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <input
                                        ...
                                        className="flex-1 px-4 py-2.5 rounded-lg bg-[var(--kit-bg)] border border-[var(--kit-border)] text-white placeholder:text-[var(--kit-text-muted)] focus:outline-none focus:border-purple-500 transition-colors code-font"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full h-64 px-4 py-3 rounded-lg bg-[var(--kit-bg)] border border-[var(--kit-border)] text-white placeholder:text-[var(--kit-text-muted)] focus:outline-none focus:border-purple-500 transition-colors code-font text-sm resize-none"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 rounded-lg bg-[var(--kit-bg)] border border-[var(--kit-border)] text-white placeholder:text-[var(--kit-text-muted)] focus:outline-none focus:border-purple-500 transition-colors"
                        ...
                        <div className="flex gap-3 px-6 py-4 border-t border-[var(--kit-border)]">
                            <button
                                ...
                                className="flex-1 py-2.5 rounded-lg bg-purple-600 hover:bg-purple-500 text-white font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                            >
